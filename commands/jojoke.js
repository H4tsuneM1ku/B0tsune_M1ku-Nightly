...
exports.run = async (client, message, args) => {
	try {
        ...
        if (!allowed.length) return message.channel.send('Il semblerait que nous soyons à court de JoJokes frais pour vous! Essayez à nouveau plus tard.');
        ...
        .setFooter("JoJoke fourni par r/ShitPostCrusaders")
